...
const defaultMeta = {
  ...
  siteName: 'Clinique Muller',
  description:
    'Profitez d’un savoir-faire inégalé et de technologies exclusives en matière d’épilation laser et électrique adaptées à toutes les peaux au meilleur prix.',
  /** Without additional '/' on the end, e.g. https://theodorusclarence.com */
  url: 'https://cliniquemuller.ch',
  type: 'website',
  robots: 'follow, index',
  /**
   ...
   */
  image: 'https://www.cliniquemuller.ch/images/homepage/hero.webp',
  keywords: 'Clinique Muller',
};
