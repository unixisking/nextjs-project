...
import { FAQ_OFFRE_NOV, LAUNCH_DATE } from '@/data/constants';
    ...
    <div>
      ...
      >
        <div className='bg-[#FDF9F5]'>
          <Seo
            title='Offre -20% épilation laser forfait à vie | Clinique Muller'
            description='Offre limitée - Lausanne l Profitez de 20% de réduction sur l’épilation laser “aisselles + jambes + maillot” à partir de 447 CHF/séance'
            keywords='Épilation définitive; épilation définitive lausanne; épilation définitive prix'
          />
                ...
                <div className='space-y-[20px] lg:pt-8'>
                  <div className='hidden lg:block'>
                    ...
                    <h1 className='py-4 font-philosopher text-2xl font-bold  uppercase leading-[4rem] text-[#A8755C] lg:text-[62px] xlheight:mt-0'>
                      <span className=' text-[#FC915B] '>-20%</span> SUR VOTRE{' '}
                      <br />
                      ÉPILATION LASER
                    </h1>
                  </div>
          ...
          <section className='mx-auto max-w-7xl text-[#844025]'>
            <div className='mx-auto flex flex-col space-y-[28px] text-center'>
              <h2 className='font-philosopher'>
                Bénéficiez d’une réduction de 20% sur votre épilation laser
              </h2>
            ...
            <div className='mt-12 flex max-w-7xl flex-col justify-between gap-x-12 lg:mt-24 lg:flex-row'>
              <div className='space-y-[28px]'>
                ...
                <img src='/images/offre-de-novembre/woman.webp' alt='' />
              </div>
            ...
            <div className='mt-12 flex max-w-7xl flex-col-reverse justify-between gap-x-12 lg:mt-24 lg:flex-row'>
              ...
              <div className='space-y-[28px]'>
                ...
                <img src='/images/offre-de-novembre/man.webp' alt='' />
              </div>
            </div>
          </section>
          ...
          <section className='mt-12 lg:mt-24'>
            <div className='mx-auto mb-8 flex flex-col space-y-[28px] text-center lg:mb-16'>
              <h2 className='font-philosopher text-[#A8755C]'>
                Profiter de l’offre d’épilation laser
              </h2>
            </div>
            <div className='mx-auto grid max-w-7xl grid-cols-1 gap-[32px] text-center text-[#844025] lg:grid-cols-2'>
              <div className='space-y-2'>
                ...
                <h5>
                  Payez moins 20% sur vos séances uniques, packs de 5 séances et
                  forfaits à vie de votre épilation laser.
                </h5>
              </div>
              ...
              <div className='space-y-2'>
                ...
                <h5>Standards de prise en charge de qualité.</h5>
              </div>
            </div>
          </section>
