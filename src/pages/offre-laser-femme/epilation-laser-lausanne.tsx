...
import { OfferCard } from '@/pages/offre-laser-homme/epilation-laser-lausanne';
...
export default function Page() {
  ...
  return (
    <Layout isNavbarHidden isBackgroundLight FooterBackground='bg-[#EAEAEA]'>
      <Seo
        title='ÉPILATION LASER FEMME : 1 FORFAIT À VIE ACHETÉ = 1 OFFERT'
        description="Économisez plus de 800 CHF sur votre épilation laser à Lausanne. 1 forfait à vie Aisselles OFFERT à l'achat d'un forfait à vie Jambes + Maillot."
        image='https://www.cliniquemuller.ch/images/offre-de-janvier/meta-image-femme.webp'
      />
        ...
        <main className='grid grid-cols-1 gap-[106px] lg:grid-cols-2'>
          <div className='relative'>
            <p className='text-center font-secondary text-lg font-bold text-[#D88F1A] lg:text-left 2xl:text-xl'>
              Économisez plus de 800 CHF sur votre épilation laser
            </p>
            ...
            <div>
              <p className='mt-8 text-center font-secondary text-lg text-[#2D2929] lg:text-left 2xl:text-xl'>
                Pour l’achat d’un forfait d’épilation laser à vie “Jambes
                complètes + Maillot”, nous vous offrons un forfait épilation
                laser à vie “Aisselles”
              </p>
          ...
          <div className='mx-auto grid grid-cols-3 gap-y-4'>
            <div className='col-span-3 mx-auto xl:mx-0 '>
              <HeroCard
                title='Achetez'
                subTitle='1 Offre Jambes Complètes + Maillot !'
                imagePath='/images/offre-de-janvier/hero-women-1.png'
              />
            </div>
            <img
            ...
            <div className='col-span-3 mx-auto xl:col-span-2 xl:mx-auto'>
              <HeroCard
                title='Gagnez'
                subTitle='1 Offre Aisselles'
                imagePath='/images/offre-de-janvier/hero-women-2.png'
              />
            </div>
          </div>
        </main>
      ...
      <section className='mt-[104px] bg-[#EAEAEA]'>
        <div className='mx-10 max-w-4xl space-y-8 py-16 sm:mx-auto'>
          <div className='space-y-8 text-center'>
            <h2 className='text-center font-secondary text-3xl font-bold leading-[35px] text-[#2D2929] sm:mt-[27px] 2xl:text-4xl'>
              Notre Offre D’épilation Laser Pour Femmes
            </h2>
            ...
            <p className='text-sm 2xl:text-base'>
              Obtenez la peau douce et soyeuse dont vous avez toujours rêvé avec
              notre offre d’épilation laser à vie exclusive à Lausanne.
            </p>
            <p>
              Pour le prix d&apos;un forfait à vie combiné{' '}
              <strong>jambes complètes</strong> +{' '}
              <strong>maillot complet</strong>, bénéficiez{' '}
              <strong>GRATUITEMENT</strong> d’un forfait à vie{' '}
              <strong>aisselles</strong> !
            </p>
          </div>
          <div className='flex flex-col items-center gap-2 lg:flex-row'>
            <OfferCard
              title='jambes complètes, maillot à choix'
              price='4’066 CHF'
            />
            <span className='text-[40px] font-bold text-[#A52F2F]'>+</span>
            <OfferCard title='Aisselles' price='757 CHF' />
            <span className='text-[40px] font-bold text-[#A52F2F]'>=</span>
            <OfferCard
              title='jambes complètes, 
                maillot à choix  + Aisselles'
              price='4’000 CHF'
              oldPrice='4’823 CHF'
            />
          </div>
          <div className='text-center'>
            <p className='mb-4'>
              Et on arrondit même à 4’000 CHF, soit une économie de plus de 800
              CHF !
            </p>
            <Link href='/offre-laser-homme/epilation-laser-lausanne'>
      ...
      <div className='mx-10 mt-[104px] md:mx-20 2xl:mx-auto 2xl:max-w-[1400px]'>
          ...
          <div className='flex flex-col md:flex-row md:items-start md:gap-x-16 lg:gap-x-[104px]'>
            <div className='relative mt-8 md:w-1/2'>
              ...
              <p className='font-secondary text-[#2D2929]'>
                ...
                testé pour vous notre traitement d&apos;épilation laser à
                Lausanne :
              </p>
              <div className='mt-4'>
                <img
        ...
        <section className='mt-[104px]'>
          ...
          <div className='grid grid-cols-1 items-start gap-12 md:grid-cols-2 md:items-center md:gap-16 xl:gap-[104px]'>
            <img
              src='/images/offre-de-janvier/NumberSessionSection.webp'
              alt='offre speciale'
              className='hidden w-[272px] justify-self-center md:block md:w-full'
            />
            <div className='w-full justify-self-center'>
              ...
              <div className='pt-8 md:pt-0 lg:pt-8 xl:pt-0'>
                ...
                <Link href='/reservez-laser-electrolyse'>
                  <Button
                    ...
                    className='bg-red mx-auto mt-8 flex w-fit justify-center rounded-tl-3xl rounded-br-3xl px-[60px] py-[16px] font-secondary text-[12px] text-white md:mx-0 md:px-[40px] lg:mt-[55px] xl:mt-8 2xl:text-sm'
                  >
                    Obtenir un forfait aisselles gratuit
                  </Button>
                </Link>
              </div>
            </div>
            ...
            <div className='w-full justify-self-center'>
              ...
              <div className='pt-8 md:pt-0 lg:pt-8 xl:pt-0'>
                ...
                <p className='mt-8 font-secondary font-medium md:mt-0 xl:mt-8'>
                  ...
                  <br />
                  <br />
                  En achetant le forfait combiné à vie jambes complètes +
                  maillot complet, vous bénéficierez d’un forfait aisselles à
                  vie offert !
                  <br />
                  <br />
...
export const OfferCta = ({
  ...
  message: ReactNode;
  button: { message: string; to: string };
}) => (
  <div className='mx-auto flex w-full flex-col items-center rounded-tl-[200px] bg-[#EAEAEA] py-[70px] lg:rounded-tl-[320px]'>
    <div className='mx-auto flex max-w-[275px] flex-col items-center sm:max-w-xl lg:max-w-7xl'>
      <p className='text-center text-lg 2xl:text-2xl'>{message}</p>
      <Link href={button.to}>
        <Button
          type='submit'
          variant='primary'
          className='bg-red mx-8 mt-8 rounded-tl-3xl rounded-br-3xl px-[54px] py-[23px] font-secondary text-sm text-white 2xl:text-base'
        >
          {button.message}
        </Button>
      </Link>
