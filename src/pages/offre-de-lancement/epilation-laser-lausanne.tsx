...
export default function OffreDeLancementLandingPage() {
  return (
    <Layout isBackgroundLight>
      <Seo
        title='Offre de lancement épilation laser forfait à vie | Clinique Muller'
        description="Offre limitée - Lausanne Profitez de notre promo de lancement: un forfait d’épilation
laser corps entier à vie au prix de 3999 CHF au lieu de 35'665 CHF"
        keywords='Épilation laser; épilation laser lausanne'
      />
      <div className='font-popins relative flex justify-center bg-[#E54545] py-1 text-center text-[22px] font-bold text-white '>
        Offre terminée
        <Link href='/faq-epilation-definitive'>
          <p className='absolute right-2 cursor-pointer text-base font-normal lg:right-36 '>
            Help & FAQs
          </p>
        </Link>
      </div>
      <main className='relative z-10 w-screen bg-[#EFEAE0] lg:h-[980px]'>
        <div>
          ...
          <div className='mx-[45px] grid pt-56 lg:mx-[80px] lg:grid-cols-2 lg:pt-[140px]'>
            <div className='space-y-[20px] lg:pt-8'>
              <div className='hidden lg:block'>
                <h2 className='font-secondary text-[12px] font-bold lg:text-[22px]'>
                  OFFRE DE LANCEMENT
                </h2>
              ...
              <p>
                ...
                pour corps entier au prix de 3&apos;999.- au lieu de 35&apos;665
                CHF.
                <br />
                <strong>
                  Possibilité de paiement en 1, 3, 6 ou 12 mensualités, sans
                  intérêt.
                </strong>
              </p>
              <Link href='/reservez-laser-electrolyse'>
                <Button
                  variant='primary'
                  className='mx-auto flex w-2/3 justify-center rounded-tl-3xl rounded-br-3xl lg:mx-0'
                >
                  Profiter de l&apos;offre
                </Button>
              </Link>
      ...
      <section className='relative mx-[40px] mt-12 lg:mt-24'>
        <div className='grid-col-1 grid lg:grid-cols-2'>
          <div className='hidden lg:mx-auto lg:block'>
            <img
              src='/images/offre-de-lancement/info.webp'
              width={400}
              height={550}
              alt='Offre de lancement'
            />
          ...
          <div className='mx-auto space-y-6 px-4 text-center lg:mr-16'>
            <h2 className='font-light uppercase'>
              Tout savoir sur l&apos;offre de lancement
            </h2>
...
sessions d’épilation laser ou de retouches nécessaires pour votre traitement.'
              ...
              <Accordion.UnControlled
                ...
                content='Oui. Réservez dès maintenant cette offre et demandez le paiement en 3, 6, ou 12 fois lors
                de la séance d’information gratuite qui précède les séances d’épilation laser.'
              />

              <Accordion.UnControlled
                title={`En cas de grossesse, puis-je toujours bénéficier de l'offre "forfait corps entier à vie" ?`}
                content="Oui, votre offre reste toujours valable, et ce, même en période de grossesse ou
                d'allaitement.<br/><br/>Néanmoins, par mesure de prévention, nous ne pouvons pas traiter au laser les femmes
                enceintes ou allaitantes. Une fois que la période de grossesse ou d'allaitement est terminée,
                vous pouvez reprendre le traitement."
              />
              <Accordion.UnControlled
                ...
                content={
                  <div className='space-y-2 text-left'>
                    ...
                    <ul className='list-disc'>
                      <li>
                        lors d&apos;une repousse due à une prise de médicaments,
                      </li>
                      <li>
      ...
      <Section
        ...
        image={
          <img
            src='/images/offre-de-lancement/epilation-accessible.webp'
      ...
      <Section
        ...
        description={
          <div>
            <p>
              ...
              rasoir et optez pour les avantages extraordinaires que vous offre
              <br />
              l&apos;épilation laser :
            </p>
          </div>
        ...
        image={
          <img
            src='/images/offre-de-lancement/peau-sublime.webp'
      ...
      <Section
        ...
        image={
          <img
            src='/images/offre-de-lancement/prix-epilation-laser.webp'
      ...
      <Section
        ...
        image={
          <img
            src='/images/offre-de-lancement/service-exceptionnel.webp'
            alt='Un service exceptionnel allié à une technologie de pointe'
          />
        }
      />
      <section className='cta-banner mt-12 border-b-[.5px] border-primary bg-[#F6F1E7] px-4 py-16 text-center lg:mt-24 lg:h-64'>
